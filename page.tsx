...
const iconData: IconData[] = [
  {
    name: "FeatureOne",
    website: "https://featureone.example.com",
    position: [2, 1, -5],
    color: "#01ADEF",
    Icon: "F1",
  },
  {
    name: "FeatureTwo",
    website: "https://featuretwo.example.com",
    position: [-3, 2, -8],
    color: "#ffffff",
    Icon: "F2",
  },
  {
    name: "FeatureThree",
    website: "https://featurethree.example.com",
    position: [4, -1, -12],
    color: "#01ADEF",
    Icon: "F3",
  },
  {
    name: "FeatureFour",
    website: "https://featurefour.example.com",
    position: [-2, -2, -6],
    color: "#ffffff",
    Icon: "F4",
  },
    ...
    <div className="w-full h-screen bg-gradient-to-br from-[#08075C] via-[#01ADEF] to-white overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-10">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-white border border-white/20">
          <h1 className="text-2xl font-bold mb-2">Welcome to Arash AI</h1>
          <p className="text-sm opacity-80">Click on any icon to learn more</p>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 right-4 z-10">
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-white text-sm border border-white/20">
          <p>Drag to explore • Scroll to zoom • Click icons to visit sites</p>
        </div>
      </div>
    </div>
  );
